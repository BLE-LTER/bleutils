...
#' @param station_source (character) URL or file path to Core Program stations coordinates file. Defaults to https://utexas.box.com/shared/static/p6a8956afbsfh19422p8xhhtiqmf7eqy.csv.
...
add_cp_cols <- function(df, station_code_col = "station", station_source = "https://utexas.box.com/shared/static/p6a8956afbsfh19422p8xhhtiqmf7eqy.csv") {
