...
#' @param station_code_col (character) Name of column containing BLE LTER station codes
...
update_cp_stations <- function(source_file = "C:/Users/atn893/Documents/Box Sync/Beaufort LTER/Core Program/BLE_LTER_CP_Stations.xlsx",
  ...
  if (all(station_info == canon)) message("Package version of station info is up-to-date. No actions taken.")
  else {
